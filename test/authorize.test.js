...
describe('Authorize', function () {
    ...
    before(function (done) {
        ...
        app.use(app.expressx.bodyParser.urlencoded({extended: false}));
        app.use(app.expressx.bodyParser.json({strict: false}));
    ...
    var model = app.sapp.models['OAuthAccessToken'];

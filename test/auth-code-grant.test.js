...
describe('AuthCodeGrant', function () {
    ...
    beforeEach(function (done) {
        ...
        app.sapp.models['OAuthPermission'].destroyAll(done);
    });
    ...
    it('should detect invalid client', function (done) {
        request
            ...
            //.expect('WWW-Authenticate', 'Basic realm="oAuth 2.0 client authentication"')
            //.expect(401, done);
    });
    ...
    it('should deny code request if user rejects', function (done) {
        requestCodeOrToken(CODE, REDIRECT_URI, 'deny', done);
    });

    it('should deny token request if user rejects', function (done) {
